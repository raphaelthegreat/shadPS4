...
using VideoOutFormat = Core::Libraries::VideoOut::PixelFormat;
using Core::Libraries::VideoOut::TilingMode;
...
ImageInfo::ImageInfo(const Core::Libraries::VideoOut::BufferAttributeGroup& group) noexcept {
