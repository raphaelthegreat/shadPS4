...
constexpr static size_t MAX_STUBS = 128;
...
static NidEntry* stub_nids[MAX_STUBS];
...
u64 GetStub(std::string_view nid) {
    ...
    return reinterpret_cast<u64>(stub_handlers[UsedStubEntries++]);
}
