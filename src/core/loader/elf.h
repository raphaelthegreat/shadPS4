...
enum e_version_es : u32 {
    EV_NONE = 0x0,
    EV_CURRENT = 0x1
};

enum ident_class_es : u8 {
    ELF_CLASS_NONE  =0x0,
    ELF_CLASS_32	=0x1,
	ELF_CLASS_64	=0x2,
    ELF_CLASS_NUM	=0x3
...
enum ident_version_es : u8 {
    ELF_VERSION_NONE = 0x0,
    ELF_VERSION_CURRENT = 0x1,
    ELF_VERSION_NUM = 0x2
};

enum ident_osabi_es : u8 {
...
struct elf_symbol {
    u8 GetBind() const { return st_info >> 4u; }
    u8 GetType() const { return st_info & 0xfu; }
    u8 GetVisibility() const { return st_other & 3u; }
